...
${TESTDIR}/_ext/1ba7ad3b/ExtFunctions.o: ../Worked/External/ExtFunctions.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -DCPU -DDEBUG -DPI -DPLATFORM_LINUX -I../EEG_Evoker -I. -Imodels/include -Icoap -Ijson -Imalloc -Imodels -IExternal -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/_ext/1ba7ad3b/ExtFunctions.o ../Worked/External/ExtFunctions.c


${TESTDIR}/_ext/1ba7ad3b/UpdateModule.o: ../Worked/External/UpdateModule.c 
	${MKDIR} -p ${TESTDIR}/_ext/1ba7ad3b
	${RM} "$@.d"
	$(COMPILE.c) -O2 -DCPU -DDEBUG -DPI -DPLATFORM_LINUX -I../EEG_Evoker -I. -Imodels/include -Icoap -Ijson -Imalloc -Imodels -IExternal -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/_ext/1ba7ad3b/UpdateModule.o ../Worked/External/UpdateModule.c
