...
${OBJECTDIR}/coap/coap.o: coap/coap.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -DCPU -DPI -DPLATFORM_LINUX -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/coap/coap.o coap/coap.c
...
${OBJECTDIR}/json/cJSON.o: json/cJSON.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -DCPU -DPI -DPLATFORM_LINUX -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/json/cJSON.o json/cJSON.c

${OBJECTDIR}/json/cJSON_Utils.o: json/cJSON_Utils.c
	${MKDIR} -p ${OBJECTDIR}/json
	${RM} "$@.d"
	$(COMPILE.c) -O2 -DCPU -DPI -DPLATFORM_LINUX -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/json/cJSON_Utils.o json/cJSON_Utils.c

${OBJECTDIR}/malloc/umm_malloc.o: malloc/umm_malloc.c
	${MKDIR} -p ${OBJECTDIR}/malloc
	${RM} "$@.d"
	$(COMPILE.c) -O2 -DCPU -DPI -DPLATFORM_LINUX -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/malloc/umm_malloc.o malloc/umm_malloc.c

${OBJECTDIR}/models/src/array.o: models/src/array.c
	${MKDIR} -p ${OBJECTDIR}/models/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -DCPU -DPI -DPLATFORM_LINUX -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/models/src/array.o models/src/array.c

${OBJECTDIR}/models/src/common.o: models/src/common.c
	${MKDIR} -p ${OBJECTDIR}/models/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -DCPU -DPI -DPLATFORM_LINUX -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/models/src/common.o models/src/common.c

${OBJECTDIR}/models/src/deque.o: models/src/deque.c
	${MKDIR} -p ${OBJECTDIR}/models/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -DCPU -DPI -DPLATFORM_LINUX -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/models/src/deque.o models/src/deque.c

${OBJECTDIR}/models/src/hashset.o: models/src/hashset.c
	${MKDIR} -p ${OBJECTDIR}/models/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -DCPU -DPI -DPLATFORM_LINUX -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/models/src/hashset.o models/src/hashset.c

${OBJECTDIR}/models/src/hashtable.o: models/src/hashtable.c
	${MKDIR} -p ${OBJECTDIR}/models/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -DCPU -DPI -DPLATFORM_LINUX -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/models/src/hashtable.o models/src/hashtable.c

${OBJECTDIR}/models/src/list.o: models/src/list.c
	${MKDIR} -p ${OBJECTDIR}/models/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -DCPU -DPI -DPLATFORM_LINUX -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/models/src/list.o models/src/list.c

${OBJECTDIR}/models/src/queue.o: models/src/queue.c
	${MKDIR} -p ${OBJECTDIR}/models/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -DCPU -DPI -DPLATFORM_LINUX -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/models/src/queue.o models/src/queue.c

${OBJECTDIR}/models/src/slist.o: models/src/slist.c
	${MKDIR} -p ${OBJECTDIR}/models/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -DCPU -DPI -DPLATFORM_LINUX -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/models/src/slist.o models/src/slist.c

${OBJECTDIR}/models/src/stack.o: models/src/stack.c
	${MKDIR} -p ${OBJECTDIR}/models/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -DCPU -DPI -DPLATFORM_LINUX -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/models/src/stack.o models/src/stack.c

${OBJECTDIR}/models/src/treeset.o: models/src/treeset.c
	${MKDIR} -p ${OBJECTDIR}/models/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -DCPU -DPI -DPLATFORM_LINUX -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/models/src/treeset.o models/src/treeset.c

${OBJECTDIR}/models/src/treetable.o: models/src/treetable.c
	${MKDIR} -p ${OBJECTDIR}/models/src
	${RM} "$@.d"
	$(COMPILE.c) -O2 -DCPU -DPI -DPLATFORM_LINUX -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/models/src/treetable.o models/src/treetable.c
...
${OBJECTDIR}/coap/coap_nomain.o: ${OBJECTDIR}/coap/coap.o coap/coap.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -DCPU -DPI -DPLATFORM_LINUX -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/coap/coap_nomain.o coap/coap.c;\
	else  \
...
${OBJECTDIR}/json/cJSON_nomain.o: ${OBJECTDIR}/json/cJSON.o json/cJSON.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -DCPU -DPI -DPLATFORM_LINUX -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/json/cJSON_nomain.o json/cJSON.c;\
	else  \
...
${OBJECTDIR}/json/cJSON_Utils_nomain.o: ${OBJECTDIR}/json/cJSON_Utils.o json/cJSON_Utils.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -DCPU -DPI -DPLATFORM_LINUX -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/json/cJSON_Utils_nomain.o json/cJSON_Utils.c;\
	else  \
...
${OBJECTDIR}/malloc/umm_malloc_nomain.o: ${OBJECTDIR}/malloc/umm_malloc.o malloc/umm_malloc.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -DCPU -DPI -DPLATFORM_LINUX -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/malloc/umm_malloc_nomain.o malloc/umm_malloc.c;\
	else  \
...
${OBJECTDIR}/models/src/array_nomain.o: ${OBJECTDIR}/models/src/array.o models/src/array.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -DCPU -DPI -DPLATFORM_LINUX -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/models/src/array_nomain.o models/src/array.c;\
	else  \
...
${OBJECTDIR}/models/src/common_nomain.o: ${OBJECTDIR}/models/src/common.o models/src/common.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -DCPU -DPI -DPLATFORM_LINUX -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/models/src/common_nomain.o models/src/common.c;\
	else  \
...
${OBJECTDIR}/models/src/deque_nomain.o: ${OBJECTDIR}/models/src/deque.o models/src/deque.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -DCPU -DPI -DPLATFORM_LINUX -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/models/src/deque_nomain.o models/src/deque.c;\
	else  \
...
${OBJECTDIR}/models/src/hashset_nomain.o: ${OBJECTDIR}/models/src/hashset.o models/src/hashset.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -DCPU -DPI -DPLATFORM_LINUX -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/models/src/hashset_nomain.o models/src/hashset.c;\
	else  \
...
${OBJECTDIR}/models/src/hashtable_nomain.o: ${OBJECTDIR}/models/src/hashtable.o models/src/hashtable.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -DCPU -DPI -DPLATFORM_LINUX -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/models/src/hashtable_nomain.o models/src/hashtable.c;\
	else  \
...
${OBJECTDIR}/models/src/list_nomain.o: ${OBJECTDIR}/models/src/list.o models/src/list.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -DCPU -DPI -DPLATFORM_LINUX -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/models/src/list_nomain.o models/src/list.c;\
	else  \
...
${OBJECTDIR}/models/src/queue_nomain.o: ${OBJECTDIR}/models/src/queue.o models/src/queue.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -DCPU -DPI -DPLATFORM_LINUX -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/models/src/queue_nomain.o models/src/queue.c;\
	else  \
...
${OBJECTDIR}/models/src/slist_nomain.o: ${OBJECTDIR}/models/src/slist.o models/src/slist.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -DCPU -DPI -DPLATFORM_LINUX -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/models/src/slist_nomain.o models/src/slist.c;\
	else  \
...
${OBJECTDIR}/models/src/stack_nomain.o: ${OBJECTDIR}/models/src/stack.o models/src/stack.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -DCPU -DPI -DPLATFORM_LINUX -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/models/src/stack_nomain.o models/src/stack.c;\
	else  \
...
${OBJECTDIR}/models/src/treeset_nomain.o: ${OBJECTDIR}/models/src/treeset.o models/src/treeset.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -DCPU -DPI -DPLATFORM_LINUX -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/models/src/treeset_nomain.o models/src/treeset.c;\
	else  \
...
${OBJECTDIR}/models/src/treetable_nomain.o: ${OBJECTDIR}/models/src/treetable.o models/src/treetable.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -DCPU -DPI -DPLATFORM_LINUX -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/models/src/treetable_nomain.o models/src/treetable.c;\
	else  \
