...
${OBJECTDIR}/CSMACD.o: CSMACD.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O3 -DDEBUG -DMC -DRTOS -I../EEG_Evoker -I. -Imodels/include -Icoap -Ijson -Imalloc -Imodels -IExternal -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CSMACD.o CSMACD.c
...
${OBJECTDIR}/ExtFunctions.o: ExtFunctions.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O3 -DDEBUG -DMC -DRTOS -I../EEG_Evoker -I. -Imodels/include -Icoap -Ijson -Imalloc -Imodels -IExternal -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ExtFunctions.o ExtFunctions.c
...
${TESTDIR}/tests/cfgmemtest.o: tests/cfgmemtest.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -O3 -DDEBUG -DMC -DRTOS -I../EEG_Evoker -I. -Imodels/include -Icoap -Ijson -Imalloc -Imodels -IExternal -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/cfgmemtest.o tests/cfgmemtest.c
...
${OBJECTDIR}/CSMACD_nomain.o: ${OBJECTDIR}/CSMACD.o CSMACD.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O3 -DDEBUG -DMC -DRTOS -I../EEG_Evoker -I. -Imodels/include -Icoap -Ijson -Imalloc -Imodels -IExternal -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CSMACD_nomain.o CSMACD.c;\
	else  \
...
${OBJECTDIR}/ExtFunctions_nomain.o: ${OBJECTDIR}/ExtFunctions.o ExtFunctions.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O3 -DDEBUG -DMC -DRTOS -I../EEG_Evoker -I. -Imodels/include -Icoap -Ijson -Imalloc -Imodels -IExternal -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ExtFunctions_nomain.o ExtFunctions.c;\
	else  \
