...
${OBJECTDIR}/CRC16ANSI.o: CRC16ANSI.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -DCPU -DPLATFORM_WINDOWS -D__USE_W32_SOCKETS -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CRC16ANSI.o CRC16ANSI.c

${OBJECTDIR}/CommandModule.o: CommandModule.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -DCPU -DPLATFORM_WINDOWS -D__USE_W32_SOCKETS -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CommandModule.o CommandModule.c

${OBJECTDIR}/ConfigMem.o: ConfigMem.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -DCPU -DPLATFORM_WINDOWS -D__USE_W32_SOCKETS -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ConfigMem.o ConfigMem.c

${OBJECTDIR}/DMAretransmitter.o: DMAretransmitter.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -DCPU -DPLATFORM_WINDOWS -D__USE_W32_SOCKETS -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DMAretransmitter.o DMAretransmitter.c

${OBJECTDIR}/ExtMemModule.o: ExtMemModule.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -DCPU -DPLATFORM_WINDOWS -D__USE_W32_SOCKETS -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ExtMemModule.o ExtMemModule.c

${OBJECTDIR}/FunctionsDiscovery.o: FunctionsDiscovery.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -DCPU -DPLATFORM_WINDOWS -D__USE_W32_SOCKETS -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/FunctionsDiscovery.o FunctionsDiscovery.c

${OBJECTDIR}/Handler.o: Handler.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -DCPU -DPLATFORM_WINDOWS -D__USE_W32_SOCKETS -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Handler.o Handler.c

${OBJECTDIR}/InOutBuffer.o: InOutBuffer.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -DCPU -DPLATFORM_WINDOWS -D__USE_W32_SOCKETS -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/InOutBuffer.o InOutBuffer.c

${OBJECTDIR}/PWMModule.o: PWMModule.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -DCPU -DPLATFORM_WINDOWS -D__USE_W32_SOCKETS -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PWMModule.o PWMModule.c

${OBJECTDIR}/Packet.o: Packet.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -DCPU -DPLATFORM_WINDOWS -D__USE_W32_SOCKETS -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Packet.o Packet.c

${OBJECTDIR}/StreamDataRecorder.o: StreamDataRecorder.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -DCPU -DPLATFORM_WINDOWS -D__USE_W32_SOCKETS -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/StreamDataRecorder.o StreamDataRecorder.c

${OBJECTDIR}/SymbolBuffer.o: SymbolBuffer.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -DCPU -DPLATFORM_WINDOWS -D__USE_W32_SOCKETS -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SymbolBuffer.o SymbolBuffer.c

${OBJECTDIR}/UpdateModule.o: UpdateModule.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -DCPU -DPLATFORM_WINDOWS -D__USE_W32_SOCKETS -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/UpdateModule.o UpdateModule.c

${OBJECTDIR}/VideoModule.o: VideoModule.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -DCPU -DPLATFORM_WINDOWS -D__USE_W32_SOCKETS -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/VideoModule.o VideoModule.c

${OBJECTDIR}/generatorModule.o: generatorModule.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -DCPU -DPLATFORM_WINDOWS -D__USE_W32_SOCKETS -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/generatorModule.o generatorModule.c
...
${TESTDIR}/tests/discovery_func_test.o: tests/discovery_func_test.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -DCPU -DPLATFORM_WINDOWS -D__USE_W32_SOCKETS -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/discovery_func_test.o tests/discovery_func_test.c


${TESTDIR}/tests/dma_test.o: tests/dma_test.c 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.c) -O2 -DCPU -DPLATFORM_WINDOWS -D__USE_W32_SOCKETS -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/dma_test.o tests/dma_test.c


${TESTDIR}/tests/ext_mem_test.o: tests/ext_mem_test.c 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.c) -O2 -DCPU -DPLATFORM_WINDOWS -D__USE_W32_SOCKETS -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/ext_mem_test.o tests/ext_mem_test.c


${TESTDIR}/tests/file_cvep_test.o: tests/file_cvep_test.c 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.c) -O2 -DCPU -DPLATFORM_WINDOWS -D__USE_W32_SOCKETS -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/file_cvep_test.o tests/file_cvep_test.c


${TESTDIR}/tests/operation_test.o: tests/operation_test.c 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.c) -O2 -DCPU -DPLATFORM_WINDOWS -D__USE_W32_SOCKETS -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/operation_test.o tests/operation_test.c


${TESTDIR}/tests/json_parser.o: tests/json_parser.c 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.c) -O2 -DCPU -DPLATFORM_WINDOWS -D__USE_W32_SOCKETS -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/json_parser.o tests/json_parser.c


${TESTDIR}/tests/pocket_test.o: tests/pocket_test.c 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.c) -O2 -DCPU -DPLATFORM_WINDOWS -D__USE_W32_SOCKETS -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/pocket_test.o tests/pocket_test.c
...
${OBJECTDIR}/CRC16ANSI_nomain.o: ${OBJECTDIR}/CRC16ANSI.o CRC16ANSI.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -DCPU -DPLATFORM_WINDOWS -D__USE_W32_SOCKETS -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CRC16ANSI_nomain.o CRC16ANSI.c;\
	else  \
...
${OBJECTDIR}/CommandModule_nomain.o: ${OBJECTDIR}/CommandModule.o CommandModule.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -DCPU -DPLATFORM_WINDOWS -D__USE_W32_SOCKETS -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CommandModule_nomain.o CommandModule.c;\
	else  \
...
${OBJECTDIR}/ConfigMem_nomain.o: ${OBJECTDIR}/ConfigMem.o ConfigMem.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -DCPU -DPLATFORM_WINDOWS -D__USE_W32_SOCKETS -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ConfigMem_nomain.o ConfigMem.c;\
	else  \
...
${OBJECTDIR}/DMAretransmitter_nomain.o: ${OBJECTDIR}/DMAretransmitter.o DMAretransmitter.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -DCPU -DPLATFORM_WINDOWS -D__USE_W32_SOCKETS -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DMAretransmitter_nomain.o DMAretransmitter.c;\
	else  \
...
${OBJECTDIR}/ExtMemModule_nomain.o: ${OBJECTDIR}/ExtMemModule.o ExtMemModule.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -DCPU -DPLATFORM_WINDOWS -D__USE_W32_SOCKETS -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ExtMemModule_nomain.o ExtMemModule.c;\
	else  \
...
${OBJECTDIR}/FunctionsDiscovery_nomain.o: ${OBJECTDIR}/FunctionsDiscovery.o FunctionsDiscovery.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -DCPU -DPLATFORM_WINDOWS -D__USE_W32_SOCKETS -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/FunctionsDiscovery_nomain.o FunctionsDiscovery.c;\
	else  \
...
${OBJECTDIR}/Handler_nomain.o: ${OBJECTDIR}/Handler.o Handler.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -DCPU -DPLATFORM_WINDOWS -D__USE_W32_SOCKETS -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Handler_nomain.o Handler.c;\
	else  \
...
${OBJECTDIR}/InOutBuffer_nomain.o: ${OBJECTDIR}/InOutBuffer.o InOutBuffer.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -DCPU -DPLATFORM_WINDOWS -D__USE_W32_SOCKETS -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/InOutBuffer_nomain.o InOutBuffer.c;\
	else  \
...
${OBJECTDIR}/PWMModule_nomain.o: ${OBJECTDIR}/PWMModule.o PWMModule.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -DCPU -DPLATFORM_WINDOWS -D__USE_W32_SOCKETS -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PWMModule_nomain.o PWMModule.c;\
	else  \
...
${OBJECTDIR}/Packet_nomain.o: ${OBJECTDIR}/Packet.o Packet.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -DCPU -DPLATFORM_WINDOWS -D__USE_W32_SOCKETS -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Packet_nomain.o Packet.c;\
	else  \
...
${OBJECTDIR}/StreamDataRecorder_nomain.o: ${OBJECTDIR}/StreamDataRecorder.o StreamDataRecorder.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -DCPU -DPLATFORM_WINDOWS -D__USE_W32_SOCKETS -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/StreamDataRecorder_nomain.o StreamDataRecorder.c;\
	else  \
...
${OBJECTDIR}/SymbolBuffer_nomain.o: ${OBJECTDIR}/SymbolBuffer.o SymbolBuffer.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -DCPU -DPLATFORM_WINDOWS -D__USE_W32_SOCKETS -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SymbolBuffer_nomain.o SymbolBuffer.c;\
	else  \
...
${OBJECTDIR}/UpdateModule_nomain.o: ${OBJECTDIR}/UpdateModule.o UpdateModule.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -DCPU -DPLATFORM_WINDOWS -D__USE_W32_SOCKETS -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/UpdateModule_nomain.o UpdateModule.c;\
	else  \
...
${OBJECTDIR}/VideoModule_nomain.o: ${OBJECTDIR}/VideoModule.o VideoModule.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -DCPU -DPLATFORM_WINDOWS -D__USE_W32_SOCKETS -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/VideoModule_nomain.o VideoModule.c;\
	else  \
...
${OBJECTDIR}/generatorModule_nomain.o: ${OBJECTDIR}/generatorModule.o generatorModule.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -O2 -DCPU -DPLATFORM_WINDOWS -D__USE_W32_SOCKETS -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/generatorModule_nomain.o generatorModule.c;\
	else  \
