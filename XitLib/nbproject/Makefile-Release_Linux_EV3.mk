...
${TESTDIR}/External/ExtFunctions.o: External/ExtFunctions.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -DCPU -DEV3 -DPI -DPLATFORM_LINUX -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/External/ExtFunctions.o External/ExtFunctions.c
...
${TESTDIR}/tests/LogTest.o: tests/LogTest.c 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.c) -O2 -DCPU -DEV3 -DPI -DPLATFORM_LINUX -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/LogTest.o tests/LogTest.c
