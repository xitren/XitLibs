...
static uint32_t _msgs_streamer[][2] = {
    ...
    {(uint32_t) _msg_test_get_memory, sizeof (_msg_test_get_memory)},
    {(uint32_t) _msg_test_post_memory, sizeof (_msg_test_post_memory)},
    {(uint32_t) _msg_test_put_memory, sizeof (_msg_test_put_memory)},
    {(uint32_t) _msg_test_delete_memory, sizeof (_msg_test_delete_memory)},

    {(uint32_t) _msg_test_get_memory_addr_val, sizeof (_msg_test_get_memory_addr_val)},
    {(uint32_t) _msg_test_post_memory_addr_val, sizeof (_msg_test_post_memory_addr_val)},
    {(uint32_t) _msg_test_put_memory_addr_val, sizeof (_msg_test_put_memory_addr_val)},
    {(uint32_t) _msg_test_delete_memory_addr_val, sizeof (_msg_test_delete_memory_addr_val)},

    {(uint32_t) _msg_test_get_stream, sizeof (_msg_test_get_stream)},
    {(uint32_t) _msg_test_post_stream, sizeof (_msg_test_post_stream)},
    {(uint32_t) _msg_test_put_stream, sizeof (_msg_test_put_stream)},
    {(uint32_t) _msg_test_delete_stream, sizeof (_msg_test_delete_stream)},

    {(uint32_t) _msg_test_get_stream_current, sizeof (_msg_test_get_stream_current)},
    {(uint32_t) _msg_test_post_stream_current, sizeof (_msg_test_post_stream_current)},
    {(uint32_t) _msg_test_put_stream_current, sizeof (_msg_test_put_stream_current)},
    {(uint32_t) _msg_test_delete_stream_current, sizeof (_msg_test_delete_stream_current)},

    {(uint32_t) _msg_test_get_stream_last, sizeof (_msg_test_get_stream_last)},
    {(uint32_t) _msg_test_post_stream_last, sizeof (_msg_test_post_stream_last)},
    {(uint32_t) _msg_test_put_stream_last, sizeof (_msg_test_put_stream_last)},
    {(uint32_t) _msg_test_delete_stream_last, sizeof (_msg_test_delete_stream_last)},
