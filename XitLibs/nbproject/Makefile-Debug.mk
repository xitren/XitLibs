...
${OBJECTDIR}/src/CRC16ANSI.o: src/CRC16ANSI.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -DDEBUG -Isrc/models/include -Isrc/coap -Isrc/json -Isrc/malloc -Isrc -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CRC16ANSI.o src/CRC16ANSI.c

${OBJECTDIR}/src/CSMACD.o: src/CSMACD.c
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -g -DDEBUG -Isrc/models/include -Isrc/coap -Isrc/json -Isrc/malloc -Isrc -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CSMACD.o src/CSMACD.c

${OBJECTDIR}/src/CommandModule.o: src/CommandModule.c
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -g -DDEBUG -Isrc/models/include -Isrc/coap -Isrc/json -Isrc/malloc -Isrc -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CommandModule.o src/CommandModule.c

${OBJECTDIR}/src/ConfigMem.o: src/ConfigMem.c
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -g -DDEBUG -Isrc/models/include -Isrc/coap -Isrc/json -Isrc/malloc -Isrc -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/ConfigMem.o src/ConfigMem.c

${OBJECTDIR}/src/DistCalc.o: src/DistCalc.c
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -g -DDEBUG -Isrc/models/include -Isrc/coap -Isrc/json -Isrc/malloc -Isrc -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/DistCalc.o src/DistCalc.c

${OBJECTDIR}/src/Handler.o: src/Handler.c
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -g -DDEBUG -Isrc/models/include -Isrc/coap -Isrc/json -Isrc/malloc -Isrc -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Handler.o src/Handler.c

${OBJECTDIR}/src/InOutBuffer.o: src/InOutBuffer.c
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -g -DDEBUG -Isrc/models/include -Isrc/coap -Isrc/json -Isrc/malloc -Isrc -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/InOutBuffer.o src/InOutBuffer.c

${OBJECTDIR}/src/LogModule.o: src/LogModule.c
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -g -DDEBUG -Isrc/models/include -Isrc/coap -Isrc/json -Isrc/malloc -Isrc -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/LogModule.o src/LogModule.c

${OBJECTDIR}/src/PWMModule.o: src/PWMModule.c
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -g -DDEBUG -Isrc/models/include -Isrc/coap -Isrc/json -Isrc/malloc -Isrc -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/PWMModule.o src/PWMModule.c

${OBJECTDIR}/src/Schedule.o: src/Schedule.c
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -g -DDEBUG -Isrc/models/include -Isrc/coap -Isrc/json -Isrc/malloc -Isrc -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Schedule.o src/Schedule.c

${OBJECTDIR}/src/StreamDataRecorder.o: src/StreamDataRecorder.c
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -g -DDEBUG -Isrc/models/include -Isrc/coap -Isrc/json -Isrc/malloc -Isrc -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/StreamDataRecorder.o src/StreamDataRecorder.c
...
${OBJECTDIR}/src/malloc/umm_malloc.o: src/malloc/umm_malloc.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -DDEBUG -Isrc/models/include -Isrc/coap -Isrc/json -Isrc/malloc -Isrc -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/malloc/umm_malloc.o src/malloc/umm_malloc.c

${OBJECTDIR}/src/models/src/array.o: src/models/src/array.c
	${MKDIR} -p ${OBJECTDIR}/src/models/src
	${RM} "$@.d"
	$(COMPILE.c) -g -DDEBUG -Isrc/models/include -Isrc/coap -Isrc/json -Isrc/malloc -Isrc -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/models/src/array.o src/models/src/array.c

${OBJECTDIR}/src/models/src/circularbuffer.o: src/models/src/circularbuffer.c
	${MKDIR} -p ${OBJECTDIR}/src/models/src
	${RM} "$@.d"
	$(COMPILE.c) -g -DDEBUG -Isrc/models/include -Isrc/coap -Isrc/json -Isrc/malloc -Isrc -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/models/src/circularbuffer.o src/models/src/circularbuffer.c

${OBJECTDIR}/src/models/src/common.o: src/models/src/common.c
	${MKDIR} -p ${OBJECTDIR}/src/models/src
	${RM} "$@.d"
	$(COMPILE.c) -g -DDEBUG -Isrc/models/include -Isrc/coap -Isrc/json -Isrc/malloc -Isrc -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/models/src/common.o src/models/src/common.c

${OBJECTDIR}/src/models/src/deque.o: src/models/src/deque.c
	${MKDIR} -p ${OBJECTDIR}/src/models/src
	${RM} "$@.d"
	$(COMPILE.c) -g -DDEBUG -Isrc/models/include -Isrc/coap -Isrc/json -Isrc/malloc -Isrc -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/models/src/deque.o src/models/src/deque.c

${OBJECTDIR}/src/models/src/hashset.o: src/models/src/hashset.c
	${MKDIR} -p ${OBJECTDIR}/src/models/src
	${RM} "$@.d"
	$(COMPILE.c) -g -DDEBUG -Isrc/models/include -Isrc/coap -Isrc/json -Isrc/malloc -Isrc -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/models/src/hashset.o src/models/src/hashset.c

${OBJECTDIR}/src/models/src/hashtable.o: src/models/src/hashtable.c
	${MKDIR} -p ${OBJECTDIR}/src/models/src
	${RM} "$@.d"
	$(COMPILE.c) -g -DDEBUG -Isrc/models/include -Isrc/coap -Isrc/json -Isrc/malloc -Isrc -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/models/src/hashtable.o src/models/src/hashtable.c

${OBJECTDIR}/src/models/src/list.o: src/models/src/list.c
	${MKDIR} -p ${OBJECTDIR}/src/models/src
	${RM} "$@.d"
	$(COMPILE.c) -g -DDEBUG -Isrc/models/include -Isrc/coap -Isrc/json -Isrc/malloc -Isrc -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/models/src/list.o src/models/src/list.c

${OBJECTDIR}/src/models/src/queue.o: src/models/src/queue.c
	${MKDIR} -p ${OBJECTDIR}/src/models/src
	${RM} "$@.d"
	$(COMPILE.c) -g -DDEBUG -Isrc/models/include -Isrc/coap -Isrc/json -Isrc/malloc -Isrc -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/models/src/queue.o src/models/src/queue.c

${OBJECTDIR}/src/models/src/slist.o: src/models/src/slist.c
	${MKDIR} -p ${OBJECTDIR}/src/models/src
	${RM} "$@.d"
	$(COMPILE.c) -g -DDEBUG -Isrc/models/include -Isrc/coap -Isrc/json -Isrc/malloc -Isrc -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/models/src/slist.o src/models/src/slist.c

${OBJECTDIR}/src/models/src/stack.o: src/models/src/stack.c
	${MKDIR} -p ${OBJECTDIR}/src/models/src
	${RM} "$@.d"
	$(COMPILE.c) -g -DDEBUG -Isrc/models/include -Isrc/coap -Isrc/json -Isrc/malloc -Isrc -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/models/src/stack.o src/models/src/stack.c

${OBJECTDIR}/src/models/src/treeset.o: src/models/src/treeset.c
	${MKDIR} -p ${OBJECTDIR}/src/models/src
	${RM} "$@.d"
	$(COMPILE.c) -g -DDEBUG -Isrc/models/include -Isrc/coap -Isrc/json -Isrc/malloc -Isrc -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/models/src/treeset.o src/models/src/treeset.c

${OBJECTDIR}/src/models/src/treetable.o: src/models/src/treetable.c
	${MKDIR} -p ${OBJECTDIR}/src/models/src
	${RM} "$@.d"
	$(COMPILE.c) -g -DDEBUG -Isrc/models/include -Isrc/coap -Isrc/json -Isrc/malloc -Isrc -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/models/src/treetable.o src/models/src/treetable.c
...
${TESTDIR}/tests/distcalctest.o: tests/distcalctest.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -DDEBUG -Isrc/models/include -Isrc/coap -Isrc/json -Isrc/malloc -Isrc -I. -Iextension -Itests -I. -include tests/coap_messages_example.h -std=c99 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/distcalctest.o tests/distcalctest.c


${TESTDIR}/tests/handlertest.o: tests/handlertest.c 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.c) -g -DDEBUG -Isrc/models/include -Isrc/coap -Isrc/json -Isrc/malloc -Isrc -I. -Iextension -Itests -include tests/coap_messages_example.h -std=c99 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/handlertest.o tests/handlertest.c


${TESTDIR}/tests/streamtest.o: tests/streamtest.c 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.c) -g -DDEBUG -Isrc/models/include -Isrc/coap -Isrc/json -Isrc/malloc -Isrc -I. -Iextension -Itests -I. -include tests/coap_messages_example.h -std=c99 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/streamtest.o tests/streamtest.c


${TESTDIR}/tests/circlebuffertest.o: tests/circlebuffertest.c 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.c) -g -DDEBUG -Isrc/models/include -Isrc/coap -Isrc/json -Isrc/malloc -Isrc -I. -Iextension -Itests -I. -include tests/coap_messages_example.h -std=c99 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/circlebuffertest.o tests/circlebuffertest.c


${TESTDIR}/tests/coaptest.o: tests/coaptest.c 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.c) -g -DDEBUG -Isrc/models/include -Isrc/coap -Isrc/json -Isrc/malloc -Isrc -I. -Iextension -Itests -I. -include tests/coap_messages_example.h -std=c99 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/coaptest.o tests/coaptest.c


${TESTDIR}/tests/coap_messages_example.o: tests/coap_messages_example.c 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.c) -g -DDEBUG -Isrc/models/include -Isrc/coap -Isrc/json -Isrc/malloc -Isrc -I. -Iextension -Itests -I. -include tests/coap_messages_example.h -std=c99 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/coap_messages_example.o tests/coap_messages_example.c


${TESTDIR}/tests/csmacdtest.o: tests/csmacdtest.c 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.c) -g -DDEBUG -Isrc/models/include -Isrc/coap -Isrc/json -Isrc/malloc -Isrc -I. -Iextension -Itests -I. -include tests/coap_messages_example.h -std=c99 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/csmacdtest.o tests/csmacdtest.c


${TESTDIR}/tests/memorytest.o: tests/memorytest.c 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.c) -g -DDEBUG -Isrc/models/include -Isrc/coap -Isrc/json -Isrc/malloc -Isrc -I. -Iextension -Itests -I. -include tests/coap_messages_example.h -std=c99 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/memorytest.o tests/memorytest.c
...
${OBJECTDIR}/src/CRC16ANSI_nomain.o: ${OBJECTDIR}/src/CRC16ANSI.o src/CRC16ANSI.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -DDEBUG -Isrc/models/include -Isrc/coap -Isrc/json -Isrc/malloc -Isrc -std=c99 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CRC16ANSI_nomain.o src/CRC16ANSI.c;\
	else  \
...
${OBJECTDIR}/src/CSMACD_nomain.o: ${OBJECTDIR}/src/CSMACD.o src/CSMACD.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -DDEBUG -Isrc/models/include -Isrc/coap -Isrc/json -Isrc/malloc -Isrc -std=c99 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CSMACD_nomain.o src/CSMACD.c;\
	else  \
...
${OBJECTDIR}/src/CommandModule_nomain.o: ${OBJECTDIR}/src/CommandModule.o src/CommandModule.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -DDEBUG -Isrc/models/include -Isrc/coap -Isrc/json -Isrc/malloc -Isrc -std=c99 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/CommandModule_nomain.o src/CommandModule.c;\
	else  \
...
${OBJECTDIR}/src/ConfigMem_nomain.o: ${OBJECTDIR}/src/ConfigMem.o src/ConfigMem.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -DDEBUG -Isrc/models/include -Isrc/coap -Isrc/json -Isrc/malloc -Isrc -std=c99 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/ConfigMem_nomain.o src/ConfigMem.c;\
	else  \
...
${OBJECTDIR}/src/DistCalc_nomain.o: ${OBJECTDIR}/src/DistCalc.o src/DistCalc.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -DDEBUG -Isrc/models/include -Isrc/coap -Isrc/json -Isrc/malloc -Isrc -std=c99 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/DistCalc_nomain.o src/DistCalc.c;\
	else  \
...
${OBJECTDIR}/src/Handler_nomain.o: ${OBJECTDIR}/src/Handler.o src/Handler.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -DDEBUG -Isrc/models/include -Isrc/coap -Isrc/json -Isrc/malloc -Isrc -std=c99 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Handler_nomain.o src/Handler.c;\
	else  \
...
${OBJECTDIR}/src/InOutBuffer_nomain.o: ${OBJECTDIR}/src/InOutBuffer.o src/InOutBuffer.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -DDEBUG -Isrc/models/include -Isrc/coap -Isrc/json -Isrc/malloc -Isrc -std=c99 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/InOutBuffer_nomain.o src/InOutBuffer.c;\
	else  \
...
${OBJECTDIR}/src/LogModule_nomain.o: ${OBJECTDIR}/src/LogModule.o src/LogModule.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -DDEBUG -Isrc/models/include -Isrc/coap -Isrc/json -Isrc/malloc -Isrc -std=c99 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/LogModule_nomain.o src/LogModule.c;\
	else  \
...
${OBJECTDIR}/src/PWMModule_nomain.o: ${OBJECTDIR}/src/PWMModule.o src/PWMModule.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -DDEBUG -Isrc/models/include -Isrc/coap -Isrc/json -Isrc/malloc -Isrc -std=c99 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/PWMModule_nomain.o src/PWMModule.c;\
	else  \
...
${OBJECTDIR}/src/Schedule_nomain.o: ${OBJECTDIR}/src/Schedule.o src/Schedule.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -DDEBUG -Isrc/models/include -Isrc/coap -Isrc/json -Isrc/malloc -Isrc -std=c99 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Schedule_nomain.o src/Schedule.c;\
	else  \
...
${OBJECTDIR}/src/StreamDataRecorder_nomain.o: ${OBJECTDIR}/src/StreamDataRecorder.o src/StreamDataRecorder.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -DDEBUG -Isrc/models/include -Isrc/coap -Isrc/json -Isrc/malloc -Isrc -std=c99 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/StreamDataRecorder_nomain.o src/StreamDataRecorder.c;\
	else  \
...
${OBJECTDIR}/src/malloc/umm_malloc_nomain.o: ${OBJECTDIR}/src/malloc/umm_malloc.o src/malloc/umm_malloc.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -DDEBUG -Isrc/models/include -Isrc/coap -Isrc/json -Isrc/malloc -Isrc -std=c99 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/malloc/umm_malloc_nomain.o src/malloc/umm_malloc.c;\
	else  \
...
${OBJECTDIR}/src/models/src/array_nomain.o: ${OBJECTDIR}/src/models/src/array.o src/models/src/array.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -DDEBUG -Isrc/models/include -Isrc/coap -Isrc/json -Isrc/malloc -Isrc -std=c99 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/models/src/array_nomain.o src/models/src/array.c;\
	else  \
...
${OBJECTDIR}/src/models/src/circularbuffer_nomain.o: ${OBJECTDIR}/src/models/src/circularbuffer.o src/models/src/circularbuffer.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -DDEBUG -Isrc/models/include -Isrc/coap -Isrc/json -Isrc/malloc -Isrc -std=c99 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/models/src/circularbuffer_nomain.o src/models/src/circularbuffer.c;\
	else  \
...
${OBJECTDIR}/src/models/src/common_nomain.o: ${OBJECTDIR}/src/models/src/common.o src/models/src/common.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -DDEBUG -Isrc/models/include -Isrc/coap -Isrc/json -Isrc/malloc -Isrc -std=c99 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/models/src/common_nomain.o src/models/src/common.c;\
	else  \
...
${OBJECTDIR}/src/models/src/deque_nomain.o: ${OBJECTDIR}/src/models/src/deque.o src/models/src/deque.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -DDEBUG -Isrc/models/include -Isrc/coap -Isrc/json -Isrc/malloc -Isrc -std=c99 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/models/src/deque_nomain.o src/models/src/deque.c;\
	else  \
...
${OBJECTDIR}/src/models/src/hashset_nomain.o: ${OBJECTDIR}/src/models/src/hashset.o src/models/src/hashset.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -DDEBUG -Isrc/models/include -Isrc/coap -Isrc/json -Isrc/malloc -Isrc -std=c99 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/models/src/hashset_nomain.o src/models/src/hashset.c;\
	else  \
...
${OBJECTDIR}/src/models/src/hashtable_nomain.o: ${OBJECTDIR}/src/models/src/hashtable.o src/models/src/hashtable.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -DDEBUG -Isrc/models/include -Isrc/coap -Isrc/json -Isrc/malloc -Isrc -std=c99 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/models/src/hashtable_nomain.o src/models/src/hashtable.c;\
	else  \
...
${OBJECTDIR}/src/models/src/list_nomain.o: ${OBJECTDIR}/src/models/src/list.o src/models/src/list.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -DDEBUG -Isrc/models/include -Isrc/coap -Isrc/json -Isrc/malloc -Isrc -std=c99 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/models/src/list_nomain.o src/models/src/list.c;\
	else  \
...
${OBJECTDIR}/src/models/src/queue_nomain.o: ${OBJECTDIR}/src/models/src/queue.o src/models/src/queue.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -DDEBUG -Isrc/models/include -Isrc/coap -Isrc/json -Isrc/malloc -Isrc -std=c99 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/models/src/queue_nomain.o src/models/src/queue.c;\
	else  \
...
${OBJECTDIR}/src/models/src/slist_nomain.o: ${OBJECTDIR}/src/models/src/slist.o src/models/src/slist.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -DDEBUG -Isrc/models/include -Isrc/coap -Isrc/json -Isrc/malloc -Isrc -std=c99 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/models/src/slist_nomain.o src/models/src/slist.c;\
	else  \
...
${OBJECTDIR}/src/models/src/stack_nomain.o: ${OBJECTDIR}/src/models/src/stack.o src/models/src/stack.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -DDEBUG -Isrc/models/include -Isrc/coap -Isrc/json -Isrc/malloc -Isrc -std=c99 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/models/src/stack_nomain.o src/models/src/stack.c;\
	else  \
...
${OBJECTDIR}/src/models/src/treeset_nomain.o: ${OBJECTDIR}/src/models/src/treeset.o src/models/src/treeset.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -DDEBUG -Isrc/models/include -Isrc/coap -Isrc/json -Isrc/malloc -Isrc -std=c99 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/models/src/treeset_nomain.o src/models/src/treeset.c;\
	else  \
...
${OBJECTDIR}/src/models/src/treetable_nomain.o: ${OBJECTDIR}/src/models/src/treetable.o src/models/src/treetable.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -DDEBUG -Isrc/models/include -Isrc/coap -Isrc/json -Isrc/malloc -Isrc -std=c99 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/models/src/treetable_nomain.o src/models/src/treetable.c;\
	else  \
