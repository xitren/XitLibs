...
LDLIBSOPTIONS=../EEG_Evoker/dist/Debug//libeeg_evoker.a ../XitLib/dist/Debug_Windows/Cygwin-Windows/libxitlib.a ../CoAP/dist/Debug//libcoap.a -lWs2_32

# Build Targets
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/iot_server.exe

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/iot_server.exe: ../EEG_Evoker/dist/Debug//libeeg_evoker.a

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/iot_server.exe: ../XitLib/dist/Debug_Windows/Cygwin-Windows/libxitlib.a

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/iot_server.exe: ../CoAP/dist/Debug//libcoap.a
...
${OBJECTDIR}/_ext/83d34d09/ExtFunctions.o: ../XitLib/External/ExtFunctions.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -DCPU -DDEBUG -DPLATFORM_WINDOWS -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/83d34d09/ExtFunctions.o ../XitLib/External/ExtFunctions.c
